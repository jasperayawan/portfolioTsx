...
const Welcome: React.FC = () => {
  ...
  return (
    <div className="min-h-[90vh] flex flex-col justify-center items-start px-[200px] dark:bg-[#1c1f21] dark:text-[#CED2D4]">
      ...
      <h1 className="font-Krona-One text-5xl me-auto leading-[65px]">
