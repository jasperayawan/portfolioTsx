...
const Nav: React.FC = () => {
  ...
  return (
    <nav className='flex flex-row justify-between items-center p-5 lg:p-10 w-full dark:text-[#C3D2D4] dark:bg-[#1c1f21]'>
        ...
        <CiMenuFries className='md:hidden' fontSize={30}/>
    </nav>
  )
}
